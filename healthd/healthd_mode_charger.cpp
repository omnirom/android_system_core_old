...
#ifndef HEALTHD_UNPLUGGED_SHUTDOWN_TIME
#define HEALTHD_UNPLUGGED_SHUTDOWN_TIME 5
#endif
#define UNPLUGGED_SHUTDOWN_TIME (HEALTHD_UNPLUGGED_SHUTDOWN_TIME * MSEC_PER_SEC)
